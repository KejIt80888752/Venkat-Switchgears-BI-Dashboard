...
export const inventoryItems = [
  { product: "LT Switchgear Panel (400A)",    category: "Panels",       unit1: 12, unit2: 8,  minLevel: 10, unitOfMeasure: "Nos" },
  { product: "LT Switchgear Panel (630A)",    category: "Panels",       unit1: 6,  unit2: 4,  minLevel: 8,  unitOfMeasure: "Nos" },
  { product: "MCC Panel (Standard)",          category: "Panels",       unit1: 8,  unit2: 5,  minLevel: 6,  unitOfMeasure: "Nos" },
  { product: "Distribution Board (12-way)",   category: "DB/PDB",       unit1: 32, unit2: 24, minLevel: 20, unitOfMeasure: "Nos" },
  { product: "Distribution Board (24-way)",   category: "DB/PDB",       unit1: 18, unit2: 12, minLevel: 15, unitOfMeasure: "Nos" },
  { product: "MCCB 63A (3P)",                 category: "Breakers",     unit1: 145,unit2: 92, minLevel: 80, unitOfMeasure: "Nos" },
  { product: "MCCB 100A (3P)",                category: "Breakers",     unit1: 88, unit2: 56, minLevel: 60, unitOfMeasure: "Nos" },
  { product: "MCCB 250A (3P)",                category: "Breakers",     unit1: 34, unit2: 21, minLevel: 40, unitOfMeasure: "Nos" },
  { product: "MCB 16A (1P)",                  category: "Breakers",     unit1: 520,unit2: 380,minLevel: 300,unitOfMeasure: "Nos" },
  { product: "MCB 32A (1P)",                  category: "Breakers",     unit1: 380,unit2: 280,minLevel: 200,unitOfMeasure: "Nos" },
  { product: "Bus Bar Copper 100A",           category: "Bus Systems",  unit1: 280,unit2: 140,minLevel: 200,unitOfMeasure: "Mtr" },
  { product: "Bus Bar Copper 250A",           category: "Bus Systems",  unit1: 120,unit2: 60, minLevel: 150,unitOfMeasure: "Mtr" },
  { product: "Bus Duct 400A",                 category: "Bus Systems",  unit1: 45, unit2: 20, minLevel: 30, unitOfMeasure: "Mtr" },
  { product: "Capacitor 25 KVAR",             category: "Power Factor", unit1: 22, unit2: 14, minLevel: 20, unitOfMeasure: "Nos" },
  { product: "Capacitor 50 KVAR",             category: "Power Factor", unit1: 8,  unit2: 5,  minLevel: 15, unitOfMeasure: "Nos" },
  { product: "Power Cable 95 sq.mm (mtr)",    category: "Cables",       unit1: 640,unit2: 380,minLevel: 500,unitOfMeasure: "Mtr" },
  { product: "Control Cable 2.5 sq.mm (mtr)", category: "Cables",       unit1: 1200,unit2:800,minLevel: 800,unitOfMeasure: "Mtr" },
  { product: "CTs (Current Transformer)",     category: "Instruments",  unit1: 38, unit2: 22, minLevel: 40, unitOfMeasure: "Nos" },
  { product: "Indicating Lamps",             category: "Instruments",  unit1: 220,unit2:140, minLevel: 150,unitOfMeasure: "Nos" },
  { product: "Push Buttons (START/STOP)",     category: "Instruments",  unit1: 180,unit2:120, minLevel: 100,unitOfMeasure: "Nos" },
];
